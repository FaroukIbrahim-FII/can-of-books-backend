...
//     const bookEmail = req.body.ownerEmail;
...
//     KittenModel.findByIdAndUpdate(id,{bookTitle,bookDescription,bookStatus},(err,result)=>{
//         KittenModel.find({ownerEmail:bookEmail},(err,result)=>{
//             if(err)
//             {
//                 console.log(err);
//             }
